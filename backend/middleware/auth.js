...
/** ตรวจ Bearer token แล้วแปะ payload เข้า req.user */
...
/** ✅ ปรับใหม่: ถ้า route ไม่กำหนด roles → อนุญาตทั้ง admin และ customer */
function requireRole(roles = ['admin', 'customer', 'user']) {
